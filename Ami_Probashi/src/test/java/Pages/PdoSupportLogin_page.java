...
public class PdoSupportLogin_page {
    ...
    public PdoSupportLogin_page(WebDriver driver) {
    ...
    public void PdoSupportLoginClass() throws Exception {
        String Email = BaseData.BaseEmailPdoSupport();
        String Pass = BaseData.PDOPassword();
