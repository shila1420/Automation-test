...
public class BracLoging_Page {
    ...
    public BracLoging_Page (WebDriver driver) {
    ...
    public void BracPageClass() throws Exception {
        String Email = BaseData.BaseEmailBrac();
        String Pass = BaseData.BracPassword();
