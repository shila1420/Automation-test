...
public class TTC_Loging_Page {
    ...
    public TTC_Loging_Page(WebDriver driver) {
    ...
    public void TTCLogingClass() throws Exception {
        String Email = BaseData.BaseEmailTTC();
        String Pass = BaseData.TTCPassword();
