...
public class DGLoging_Page {
        ...
        public DGLoging_Page(WebDriver driver) {
        ...
        public void DGLogingClass() throws Exception {
            String Email = BaseData.BaseEmailDG();
            String Pass = BaseData.DGPassword();
