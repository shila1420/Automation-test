...
public class PdoSupportLogin_step {
    public WebDriver driver;
    PdoSupportLogin_page pdoSupportLogin_page;

    public PdoSupportLogin_step() {
        this.driver = getDriver();
        pdoSupportLogin_page = new PdoSupportLogin_page (driver);
    }
    ...
    public void a_valid_url() throws Exception {
        ...
        waitLoad();
        pdoSupportLogin_page.PdoSupportLoginClass();
        waitLoad();
